...
func TestAccAzureRMKubernetesCluster_standardLoadBalancerProfile(t *testing.T) {
	...
	clientId := os.Getenv("ARM_CLIENT_ID")
	clientSecret := os.Getenv("ARM_CLIENT_SECRET")
	config := testAccAzureRMKubernetesCluster_standardLoadBalancerProfile(ri, clientId, clientSecret, testLocation())
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMKubernetesClusterExists(resourceName),
					resource.TestCheckResourceAttr(resourceName, "network_profile.0.load_balancer_sku", "Standard"),
					resource.TestCheckResourceAttr(resourceName, "network_profile.0.load_balancer_profile.0.managed_outbound_ips", "3"),
					resource.TestCheckResourceAttr(resourceName, "network_profile.0.load_balancer_profile.0.effective_outbound_ips.#", "3"),
				),
			},
		},
	})
...
func TestAccAzureRMKubernetesCluster_basicLoadBalancerProfile(t *testing.T) {
	...
	clientId := os.Getenv("ARM_CLIENT_ID")
	clientSecret := os.Getenv("ARM_CLIENT_SECRET")
	config := testAccAzureRMKubernetesCluster_basicLoadBalancerProfile(ri, clientId, clientSecret, testLocation())
...
func TestAccAzureRMKubernetesCluster_conflictingLoadBalancerProfile(t *testing.T) {
	...
	clientId := os.Getenv("ARM_CLIENT_ID")
	clientSecret := os.Getenv("ARM_CLIENT_SECRET")
	config := testAccAzureRMKubernetesCluster_conflictingLoadBalancerProfile(ri, clientId, clientSecret, testLocation())
...
func testAccAzureRMKubernetesCluster_standardLoadBalancerProfile(rInt int, clientId string, clientSecret string, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%d"
  location = "%s"
...
func testAccAzureRMKubernetesCluster_basicLoadBalancerProfile(rInt int, clientId string, clientSecret string, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%d"
  location = "%s"
...
func testAccAzureRMKubernetesCluster_conflictingLoadBalancerProfile(rInt int, clientId string, clientSecret string, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%d"
  location = "%s"
