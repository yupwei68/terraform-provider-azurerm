...
var _ resourceid.Formatter = FlexibleServerKeyId{}

func TestFlexibleServerKeyIDFormatter(t *testing.T) {
	actual := NewFlexibleServerKeyID("12345678-1234-9876-4563-123456789012", "resGroup1", "flexibleServer1", "key1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.DBforMySQL/flexibleServers/flexibleServer1/keys/key1"
	if actual != expected {
		t.Fatalf("Expected %q but got %q", expected, actual)
	}
}

func TestFlexibleServerKeyID(t *testing.T) {
	testData := []struct {
		Input    string
		Error    bool
		Expected *FlexibleServerKeyId
	}{
...

		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.DBforMySQL/flexibleServers/flexibleServer1/keys/",
			Error: true,
		},

		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.DBforMySQL/flexibleServers/flexibleServer1/keys/key1",
			Expected: &FlexibleServerKeyId{
	...
	for _, v := range testData {
		...
		actual, err := FlexibleServerKeyID(v.Input)
		if err != nil {
			if v.Error {
				continue
			}
