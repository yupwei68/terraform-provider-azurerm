...
import (
	...
	storagesync "github.com/terraform-providers/terraform-provider-azurerm/azurerm/internal/services/storagesync/client"
...
func (client *Client) Build(ctx context.Context, o *common.ClientOptions) error {
	...
	client.StorageSync = storagesync.NewClient(o)
